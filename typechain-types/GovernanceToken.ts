...
export interface GovernanceTokenInterface extends utils.Interface {
  ...
  functions: {
    ...
    "storage_maxSupply()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "storage_maxSupply",
    values?: undefined
  ): string;
...
export interface GovernanceToken extends BaseContract {
  ...
  functions: {
    ...
    storage_maxSupply(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    storage_maxSupply(overrides?: CallOverrides): Promise<PopulatedTransaction>;
